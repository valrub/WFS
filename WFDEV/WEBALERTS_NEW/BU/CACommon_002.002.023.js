...
var PersistObject = {
		...
		addImage: function addImage(entity) {
			var _self = this;
			_executor.reportError("177", "INFO", "Persistent settings? : " + _self._persistSettings.downloadVideoFiles, false);
			_executor.reportError("177", "INFO", "Item type 22? : " + entity.itemType, false);
			_executor.reportError("177", "INFO", "Not Use save binary for videos? : " + !_self._persistSettings.useSaveBinaryForVideos, false);
			try {
				if (_self._persistSettings.downloadVideoFiles && entity.itemType == "22" && !_self._persistSettings.useSaveBinaryForVideos) {
					...
					if (entity.imageUrl) {
						...
						//Logger.production("vutre sum Image");
