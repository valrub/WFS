...
var re = {
	url:'https://vk.com/wall-70078599_768',
	allUrls:'https://vk.com/wall-70078599_768'
};
re.placeholder2 = 1;
var oe = {};
var executor = {
            ...
            try {
                ...
                var writerId = _extract.GetAttribute(
                    ...
                    pMarker + "writerId"
							 ...
							 //Logger.production("AAA WriterID = " + writerId);
...
/*
Exception: writerId is not defined
@Scratchpad/1:2:25
*/
                    }
                }
							...
							Logger.production('ZZZZZZZZZZZZZZZZZZZZZZZZ');
							Logger.production('ZZZZZZZZZZZZZZZZZZZZZZZZ1  ' + copyPostAuthor);
							
                //-------------------Save post--------------------------
                if (copyPostAuthor !== null) {
