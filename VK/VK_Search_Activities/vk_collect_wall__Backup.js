...
//              vPostDate = vPostDate.replace('One ', '1 '); vPostDate = vPostDate.replace('one ', '1 ');
//              vPostDate = vPostDate.replace('Two ', '2 '); vPostDate = vPostDate.replace('two ', '2 ');
//              vPostDate = vPostDate.replace('Three ', '3 '); vPostDate = vPostDate.replace('three ', '3 ');
//              vPostDate = vPostDate.replace('Four ', '4 '); vPostDate = vPostDate.replace('four ', '4 ');
//              vPostDate = vPostDate.replace('Five ', '5 '); vPostDate = vPostDate.replace('five ', '5 ');
//              vPostDate = vPostDate.replace('Six ', '6 '); vPostDate = vPostDate.replace('six ', '6 ');
//              vPostDate = vPostDate.replace('Seven ', '7 '); vPostDate = vPostDate.replace('seven ', '7 ');
//              vPostDate = vPostDate.replace('Eight ', '8 '); vPostDate = vPostDate.replace('eight ', '8 ');
//              vPostDate = vPostDate.replace('Nine ', '9 '); vPostDate = vPostDate.replace('nine ', '9 ');
...
//                 originalPoster.description = vCopyPostAuthor + ' vl_collect_walls_originalPoster line 443'; //VAL
...
//                 commenter.externalId = hashCode(commentAuthor.singleNodeValue.textContent);
                
//                 //commenter.description = commentAuthor.singleNodeValue.textContent + " commenter.externalId line 691"; //VAL
...
// 						if (debug) console.info('Collect post #' + cntItems);
...
// 		if (debug && __asyncQueue.length === 0 && collectedResults !== 0) console.log("--- Collected ---\nCOMMENTS: " + collectedComments + "\nLIKES: " + collectedLikes + "\nTAGGED: " + collectedTags + "\nSHARES: " + collectedShares);
...
// }
                ...
                //originalPoster.description = vCopyPostAuthor + ' vl_collect_walls_originalPoster line 991' //VAL
